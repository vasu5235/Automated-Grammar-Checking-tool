...
def ginger_main(text):
    """main function"""
#    original_text = " ".join(sys.argv[1:])
#    original_text = "The employee go to work"
    original_text = text
...
#    to_return = results
    ...
    for result in results["LightGingerTheTextResult"]:
        if(result["Suggestions"]):
            ...
            error_words.append(text[f_i:t_i+1])
            f_i_l.append(f_i)
            t_i_l.append(t_i)
...
#    print("Corrected sentence: " + fixed_text)
#   print(f_i,t_i)
    return error_words,f_i_l,t_i_l
#    return results
